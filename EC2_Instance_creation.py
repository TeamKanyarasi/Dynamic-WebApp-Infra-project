...
user_data = """#!/bin/bash
    ...
    cd /home/ubuntu/
    git clone https://github.com/TeamKanyarasi/Grp11-web-app
...
def create_EC2_instance():
    ...
    response = ec2.create_instances(ImageId=image_id,
        ...
        TagSpecifications=[ { 'ResourceType': 'instance', 'Tags': [ { 'Key': 'Name', 'Value': 'Grp-12-web-app-backend' }, ] }, ],
        KeyName=key_name,
        UserData=user_data,
        MinCount=1,
        MaxCount=2)
